isEmpty(APPLICATION_VERSION):APPLICATION_VERSION = 0.1

isEmpty(TARGET_INSTALL_PATH):TARGET_INSTALL_PATH = /usr/bin
isEmpty(PLUGIN_INSTALL_PATH):PLUGIN_INSTALL_PATH = /usr/lib/ofdreader
isEmpty(DATA_INSTALL_PATH):DATA_INSTALL_PATH = /usr/share/ofdreader
